...
public interface IScanQueueItem {
	...
	/**
	 * Returns an indication of the percentage completed for the scan queue
	 * item.
	 * 
	...
	/**
	 * Returns the number of requests that have been made for the scan queue
	 * item.
	 * 
	 ...
	 * scanned multiple times. Duplicated issues are consolidated in the main
	 * view of scan results. You can implementIBurpExtender.newScanIssue to get
	 * details only of unique, newly discovered scan issues post-consolidation.
	 * 
