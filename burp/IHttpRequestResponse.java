...
public interface IHttpRequestResponse {
	...
	/**
	 * Sets the name of the application host to which the request should be
	 * sent.
	 * 
	 * @param host
	 ...
	 * 
	 * @param protocol
	 *            The protocol which should be used by the request. Valid values
	 *            are "http" and "https".
	 * @throws java.lang.Exception
	 */
	 ...
	 * 
	 * @param message
	 *            The request contents which should be sent to the application.
	 * @throws java.lang.Exception
	 */
	...
	/**
	 * Sets the response contents which should be processed by the invoking Burp
	 * tool.
	 * 
	 * @param message
